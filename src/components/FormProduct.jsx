        ...
        <form className="form-producto" onSubmit={(evt) => actionSubmit(evt)}>
          ...
          <div className="form-row">
            ...
            <select
              ...
              onChange={(e) => setRelatedSelected(Number(e.target.value))}
            >
              {productos.map((p, k) => (
          ...
          <div className="form-row">
            ...
            <select
              ...
              onChange={(e) => setFabricanteSelected(Number(e.target.value))}
            >
              {fabricantes.map((f, k) => (
          ...
          <div className="form-row">
            ...
            <select
              ...
              onChange={(e) => setProveedorSelected(Number(e.target.value))}
            >
              {proveedores.map((p, k) => (
